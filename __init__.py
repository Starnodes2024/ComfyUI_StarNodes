...
try:
    ...
    print(f"StarNodes: Could not load star_detailenhancer (requires opencv-python): {e}")
...
from .misc.StarFlux2Inpainter import NODE_CLASS_MAPPINGS as STARFLUX2INPAINTER_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STARFLUX2INPAINTER_NODE_DISPLAY_NAMES
...
try:
    ...
    print(f"StarNodes: Could not load StarNewsScraper (requires requests, beautifulsoup4): {e}")
...
try:
    ...
    print(f"StarNodes: Could not load StarPSDSaver (requires psd-tools): {e}")
...
try:
    ...
    print(f"StarNodes: Could not load StarPSDSaver2 (requires psd-tools): {e}")
...
try:
    ...
    print(f"StarNodes: Could not load StarPSDSaverAdvLayers (requires psd-tools): {e}")
...
try:
    ...
    print(f"StarNodes: Could not load StarPaletteExtractor (requires webcolors, scikit-learn): {e}")
...
try:
    ...
    print(f"StarNodes: Could not load star_save_panorama_jpeg_plus (requires opencv-python): {e}")
...
from .samplers.star_split_sampler_info import NODE_CLASS_MAPPINGS as STAR_SPLIT_SAMPLER_INFO_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_SPLIT_SAMPLER_INFO_NODE_DISPLAY_NAME_MAPPINGS
try:
    ...
    print(f"StarNodes: Could not load star_simple_filters (requires color-matcher): {e}")
...
from .misc.star_distilled_optimizer_zit import NODE_CLASS_MAPPINGS as STAR_DISTILLED_OPTIMIZER_ZIT_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_DISTILLED_OPTIMIZER_ZIT_NODE_DISPLAY_NAME_MAPPINGS
from .misc.star_split_sampler_option import NODE_CLASS_MAPPINGS as STAR_SPLIT_SAMPLER_OPTION_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_SPLIT_SAMPLER_OPTION_NODE_DISPLAY_NAME_MAPPINGS
...
from .image_tools.star_metadata_saver_option import NODE_CLASS_MAPPINGS as STAR_METADATA_SAVER_OPTION_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_METADATA_SAVER_OPTION_NODE_DISPLAY_NAME_MAPPINGS
from .image_tools.star_image_loader_options import NODE_CLASS_MAPPINGS as STAR_IMAGE_LOADER_OPTIONS_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_IMAGE_LOADER_OPTIONS_NODE_DISPLAY_NAME_MAPPINGS
...
try:
    ...
    print(f"StarNodes: Could not load star_ollama_prompt_helper (requires ollama). Install with: pip install ollama. Error: {e}")
...
try:
    from .image_tools.star_rtx_vsr import NODE_CLASS_MAPPINGS as STAR_ADVANCED_RTX_VSR_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_ADVANCED_RTX_VSR_NODE_DISPLAY_NAME_MAPPINGS
except Exception as e:
    print(f"StarNodes: Could not load star_rtx_vsr (requires nvidia-vfx and an RTX GPU): {e}")
    STAR_ADVANCED_RTX_VSR_NODE_MAPPINGS = {}
    STAR_ADVANCED_RTX_VSR_NODE_DISPLAY_NAME_MAPPINGS = {}
from .image_tools.star_tiled_pid_upscaler import NODE_CLASS_MAPPINGS as PID_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as PID_DISPLAY_MAPPINGS
...
from .misc.star_flux2_conditioner import NODE_CLASS_MAPPINGS as STAR_FLUX2_CONDITIONER_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_FLUX2_CONDITIONER_NODE_DISPLAY_NAME_MAPPINGS
...
from .minimax import NODE_CLASS_MAPPINGS as STAR_MINIMAX_AIO_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_MINIMAX_AIO_NODE_DISPLAY_NAME_MAPPINGS
from .image_tools.star_image_compare import NODE_CLASS_MAPPINGS as STAR_IMAGE_COMPARE_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_IMAGE_COMPARE_NODE_DISPLAY_NAME_MAPPINGS
from .image_tools.star_lucida_rmbg import NODE_CLASS_MAPPINGS as STAR_LUCIDA_RMBG_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_LUCIDA_RMBG_NODE_DISPLAY_NAME_MAPPINGS
try:
    from .video_tools import NODE_CLASS_MAPPINGS as STAR_VIDEO_TOOLS_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_VIDEO_TOOLS_NODE_DISPLAY_NAME_MAPPINGS
except Exception as e:
    print(f"StarNodes: Could not load video_tools (requires imageio-ffmpeg): {e}")
    STAR_VIDEO_TOOLS_NODE_CLASS_MAPPINGS = {}
    STAR_VIDEO_TOOLS_NODE_DISPLAY_NAME_MAPPINGS = {}
try:
    from .misc.star_output_cleaner import NODE_CLASS_MAPPINGS as STAR_OUTPUT_CLEANER_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_OUTPUT_CLEANER_NODE_DISPLAY_NAME_MAPPINGS
    STAR_OUTPUT_CLEANER_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load star_output_cleaner: {e}")
    STAR_OUTPUT_CLEANER_NODE_CLASS_MAPPINGS = {}
    STAR_OUTPUT_CLEANER_NODE_DISPLAY_NAME_MAPPINGS = {}
    STAR_OUTPUT_CLEANER_AVAILABLE = False
try:
    from .image_tools.star_size_calculator_by_side import NODE_CLASS_MAPPINGS as STAR_SIZE_CALCULATOR_BY_SIDE_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_SIZE_CALCULATOR_BY_SIDE_NODE_DISPLAY_NAME_MAPPINGS
    STAR_SIZE_CALCULATOR_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load star_size_calculator_by_side: {e}")
...
NODE_CLASS_MAPPINGS = {
    ...
    **STARFLUX2INPAINTER_NODE_MAPPINGS,
    **STARNEWS_NODE_MAPPINGS,
    ...
    **STAR_SPLIT_SAMPLER_INFO_NODE_CLASS_MAPPINGS,
    **STAR_SIMPLE_FILTERS_NODE_CLASS_MAPPINGS,
    ...
    **STAR_DISTILLED_OPTIMIZER_ZIT_NODE_MAPPINGS,
    **STAR_SPLIT_SAMPLER_OPTION_NODE_MAPPINGS,
    ...
    **STAR_METADATA_SAVER_OPTION_NODE_MAPPINGS,
    **STAR_IMAGE_LOADER_OPTIONS_NODE_MAPPINGS,
    **STAR_BOX_DRAWER_NODE_MAPPINGS,
    **STAR_IMAGE_SHIFTER_NODE_MAPPINGS,
    **STAR_PANORAMA_VIEWER_NODE_MAPPINGS,
    **STAR_PANORAMA_VIEWER_PRO_NODE_MAPPINGS,
    **STAR_KREA2_UNBOUND_NODE_MAPPINGS,
    **STAR_OLLAMA_PROMPT_HELPER_NODE_MAPPINGS,
    **STAR_TILED_SEEDVR_UPSCALER_NODE_MAPPINGS,
    **STAR_ADVANCED_RTX_VSR_NODE_MAPPINGS,
    **PID_MAPPINGS,
    **STAR_REALISTIC_FILM_GRAIN_NODE_MAPPINGS,
    **STAR_PROMPT_PICKER_NODE_CLASS_MAPPINGS,
    **STAR_SIZE_CALCULATOR_BY_SIDE_NODE_CLASS_MAPPINGS,
    **STAR_FLUX2_CONDITIONER_NODE_CLASS_MAPPINGS,
    **STAR_LTX_VIDEO_NODE_CLASS_MAPPINGS,
    **STAR_MINIMAX_AIO_NODE_CLASS_MAPPINGS,
    **STAR_IMAGE_COMPARE_NODE_CLASS_MAPPINGS,
    **STAR_LUCIDA_RMBG_NODE_CLASS_MAPPINGS,
    **STAR_VIDEO_TOOLS_NODE_CLASS_MAPPINGS,
    **STAR_OUTPUT_CLEANER_NODE_CLASS_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **STARFLUX2INPAINTER_NODE_DISPLAY_NAMES,
    **STARNEWS_NODE_DISPLAY_NAMES,
    ...
    **STAR_SPLIT_SAMPLER_INFO_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_SIMPLE_FILTERS_NODE_DISPLAY_NAME_MAPPINGS,
    ...
    **STAR_DISTILLED_OPTIMIZER_ZIT_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_SPLIT_SAMPLER_OPTION_NODE_DISPLAY_NAME_MAPPINGS,
    ...
    **STAR_METADATA_SAVER_OPTION_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_IMAGE_LOADER_OPTIONS_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_BOX_DRAWER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_IMAGE_SHIFTER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_PANORAMA_VIEWER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_PANORAMA_VIEWER_PRO_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_KREA2_UNBOUND_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_OLLAMA_PROMPT_HELPER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_TILED_SEEDVR_UPSCALER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_ADVANCED_RTX_VSR_NODE_DISPLAY_NAME_MAPPINGS,
    **PID_DISPLAY_MAPPINGS,
    **STAR_REALISTIC_FILM_GRAIN_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_PROMPT_PICKER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_SIZE_CALCULATOR_BY_SIDE_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_FLUX2_CONDITIONER_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_LTX_VIDEO_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_MINIMAX_AIO_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_IMAGE_COMPARE_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_LUCIDA_RMBG_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_VIDEO_TOOLS_NODE_DISPLAY_NAME_MAPPINGS,
    **STAR_OUTPUT_CLEANER_NODE_DISPLAY_NAME_MAPPINGS,
