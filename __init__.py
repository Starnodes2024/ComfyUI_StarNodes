...
NODE_CLASS_MAPPINGS = {**STAR_NODE_MAPPINGS, **OLLAMA_NODE_MAPPINGS, **FLUXSTART_NODE_MAPPINGS, **SD35START_NODE_MAPPINGS, **SDXLSTART_NODE_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**STAR_NODE_DISPLAY_NAMES, **OLLAMA_NODE_DISPLAY_NAMES, **FLUXSTART_NODE_DISPLAY_NAMES, **SD35START_NODE_DISPLAY_NAMES, **SDXLSTART_NODE_DISPLAY_NAMES}
