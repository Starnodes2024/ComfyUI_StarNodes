...
from .text_io.star_everything_to_int_str import NODE_CLASS_MAPPINGS as STAR_EVERYTHING_TO_INT_STR_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_EVERYTHING_TO_INT_STR_NODE_DISPLAY_NAMES
...
NODE_CLASS_MAPPINGS = {
    ...
    **STAR_EVERYTHING_TO_INT_STR_NODE_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **STAR_EVERYTHING_TO_INT_STR_NODE_DISPLAY_NAMES,
