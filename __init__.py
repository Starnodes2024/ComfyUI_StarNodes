...
# Try to import insightface-dependent nodes
try:
    ...
    INSIGHTFACE_FACESWAP_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load star_infiniteyou_face_swap_mod (insightface issue): {e}")
    STARINFINITEYOU_FACESWAP_MOD_NODE_MAPPINGS = {}
    STARINFINITEYOU_FACESWAP_MOD_NODE_DISPLAY_NAMES = {}
    INSIGHTFACE_FACESWAP_AVAILABLE = False
...
try:
    ...
    INSIGHTFACE_PATCH_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load star_infiniteyou_patch (insightface issue): {e}")
    STARINFINITEYOU_PATCH_NODE_MAPPINGS = {}
    STARINFINITEYOU_PATCH_NODE_DISPLAY_NAMES = {}
    INSIGHTFACE_PATCH_AVAILABLE = False
...
try:
    ...
    INSIGHTFACE_ADV_PATCHMAKER_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load star_infiniteyou_advanced_patch_maker (insightface issue): {e}")
    STARINFINITEYOU_ADV_PATCHMAKER_NODE_MAPPINGS = {}
    STARINFINITEYOU_ADV_PATCHMAKER_NODE_DISPLAY_NAMES = {}
    INSIGHTFACE_ADV_PATCHMAKER_AVAILABLE = False
...
try:
    ...
    INSIGHTFACE_STARINFINITEYOU_AVAILABLE = True
except Exception as e:
    print(f"StarNodes: Could not load starinfiniteyou (insightface issue): {e}")
    STARINFINITEYOU_NODE_MAPPINGS = {}
    STARINFINITEYOU_NODE_DISPLAY_NAMES = {}
    INSIGHTFACE_STARINFINITEYOU_AVAILABLE = False
...
from .external.star_minimax_prompter import NODE_CLASS_MAPPINGS as STAR_MINIMAX_PROMPTER_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as STAR_MINIMAX_PROMPTER_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **STAR_MINIMAX_PROMPTER_NODE_CLASS_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **STAR_MINIMAX_PROMPTER_NODE_DISPLAY_NAME_MAPPINGS,
